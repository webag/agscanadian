...
<section class="s-lp-header s-lp-header--nopad">
	<div class="lp-header">
		...
		<div class="lp-header__right lp-header__right--asm">
			<img src="<?=SITE_TEMPLATE_PATH?>/img/lp/membrana/header-item.png" alt="1" class="lp-header__img">
		</div>
	</div>
</section>
...
<section class="s-membran-module" data-lazybg="<?=SITE_TEMPLATE_PATH?>/img/lp/membrana/module-bg.jpg">
	<div class="container">
		<div class="row">
...
<section class="s-lp-sostav s-lp-sostav--membrana s-def-big">
	<div class="container">
		...
		<div class="sostav sostav--membrana">
			<div class="sostav__img anim">
				<img data-lazy="<?=SITE_TEMPLATE_PATH?>/img/lp/membrana/sostav-img.png" alt="1">
...
<section class="s-lp-preims" data-lazybg="<?=SITE_TEMPLATE_PATH?>/img/lp/membrana/preims-bg.jpg">
	<div class="container">
		<div class="row">
	...
	<img src="" data-lazy="<?=SITE_TEMPLATE_PATH?>/img/lp/membrana/preims-img.png" alt="" class="preims-img">
</section>
...
<section class="s-lp-variants s-def">
	<div class="container">
		...
		<div class="lp-variant selected">
			<div class="row">
				<div class="grid-6 grid-12_m">
					<img data-lazy="<?=SITE_TEMPLATE_PATH?>/img/lp/membrana/variant-1.png" alt="" class="img-responsive">
				</div>
				<div class="grid-6 grid-12_m">
					<div class="user-content">
		...
		<div class="lp-variant">
			<div class="row">
				<div class="grid-6 grid-12_m">
					<img data-lazy="<?=SITE_TEMPLATE_PATH?>/img/lp/membrana/variant-2.png" alt="" class="img-responsive">
				</div>
				<div class="grid-6 grid-12_m">
					<div class="user-content">
