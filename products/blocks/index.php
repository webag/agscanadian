...
$APPLICATION->SetTitle("Block Modular Constructions");
?>


<section class="s-lp-header s-lp-header--nopad">
	<div class="lp-header">
		<div class="lp-header__left">
			<div class="lp-header__content">
				<h1 class="lp-header__title">Block Modular Constructions</h1>
				<div class="lp-header__descr">We design and manufacture block modular designs for customer equipment</div>
				<div class="lp-header__border user-content">
					<strong>We produce modular designs based on:</strong>
					<ul>
						<li>20 ft shipping container</li>
						<li>40 ft shipping container</li>
		...
		<div class="lp-header__right lp-header__right--blocks">
			<img src="<?=SITE_TEMPLATE_PATH?>/img/lp/blocks/header-item.png" alt="1" class="lp-header__img">
		</div>
	</div>
</section>


<section class="s-module-complect s-module-complect--light s-def-big" data-lazybg="<?=SITE_TEMPLATE_PATH?>/img/lp/blocks/complect-bg.jpg">
	<div class="container">
		<div class="section-title">
			<div class="h1">Block-Modular Station Set</div>
		</div>
		<div class="row module-complect-items-row">
			<div class="grid-3 grid-6_l grid-12_xs">
				<div class="module-complect-item">
					<div class="module-complect-item__img">
	...
	<img data-lazy="<?=SITE_TEMPLATE_PATH?>/img/lp/blocks/module-complect-img.png" alt="" class="module-complect-img">
	...
	<div class="container">
		<div class="module-complect-base">
			<div class="section-title">
				<div class="h2">The main components and assemblies of a block-modular station:</div>
			</div>
			<div class="row module-complect-items-row">
...
<section class="s-lp-otrasli s-def-big">
	<div class="container">
		<div class="section-title">
			<div class="h1">The following industries choose us</div>
		</div>

		<div class="lp-otrasli-list">
			<div class="lp-otrasl">
				<img data-lazy="<?=SITE_TEMPLATE_PATH?>/img/lp/blocks/otrasl-1.jpg?v=1" alt="">
				<span>Water treatment plants</span>
			</div>
			<div class="lp-otrasl">
				<img data-lazy="<?=SITE_TEMPLATE_PATH?>/img/lp/blocks/otrasl-2.jpg?v=1" alt="">
				<span>Compressor stations</span>
			</div>
			<div class="lp-otrasl">
				<img data-lazy="<?=SITE_TEMPLATE_PATH?>/img/lp/blocks/otrasl-3.jpg?v=1" alt="">
				<span>Nitrogen and oxygen stations</span>
			</div>
			<div class="lp-otrasl">
				<img data-lazy="<?=SITE_TEMPLATE_PATH?>/img/lp/blocks/otrasl-4.jpg?v=1" alt="">
				<span>Diesel stations</span>
			</div>
			<div class="lp-otrasl">
				<img data-lazy="<?=SITE_TEMPLATE_PATH?>/img/lp/blocks/otrasl-5.jpg?v=1" alt="">
				<span>Boiler rooms</span>
			</div>
			<div class="lp-otrasl">
				<img data-lazy="<?=SITE_TEMPLATE_PATH?>/img/lp/blocks/otrasl-6.jpg?v=1" alt="">
				<span>Hydrogen stations</span>
			</div>
			<div class="lp-otrasl">
				<img data-lazy="<?=SITE_TEMPLATE_PATH?>/img/lp/blocks/otrasl-7.jpg?v=1" alt="">
				<span>CHP</span>
			</div>
			<div class="lp-otrasl">
				<img data-lazy="<?=SITE_TEMPLATE_PATH?>/img/lp/blocks/otrasl-8.jpg?v=1" alt="">
				<span>Residential complexes</span>
			</div>
			<div class="lp-otrasl">
				<img data-lazy="<?=SITE_TEMPLATE_PATH?>/img/lp/blocks/otrasl-9.jpg?v=1" alt="">
...
<section class="s-lp-factory s-def-big">
	<div class="container">
		<div class="lp-factory-grid">
			<div class="lp-factory-block lp-factory-block--big lp-factory-block--text">
				<div class="h1">Production Information</div>
				<p>Rostov Region, Novocherkassk<br>
					2000 m<sup>2</sup> production capacity<br>
					80 production employees</p>
				<a href="#" class="lp-header__video fancy-video">
					<i class="i-play round-icon"></i>
					<span>Video about product</span>
				</a>
			</div>
			<div class="lp-factory-block" data-lazybg="<?=SITE_TEMPLATE_PATH?>/img/lp/blocks/fac-1.jpg?v=2"></div>
			<div class="lp-factory-block" data-lazybg="<?=SITE_TEMPLATE_PATH?>/img/lp/blocks/fac-2.jpg?v=2"></div>
			<div class="lp-factory-block lp-factory-block--big" data-lazybg="<?=SITE_TEMPLATE_PATH?>/img/lp/blocks/fac-3.jpg?v=2"></div>
			<div class="lp-factory-block" data-lazybg="<?=SITE_TEMPLATE_PATH?>/img/lp/blocks/fac-4.jpg?v=2"></div>
			<div class="lp-factory-block" data-lazybg="<?=SITE_TEMPLATE_PATH?>/img/lp/blocks/fac-5.jpg?v=2"></div>
			<div class="lp-factory-block lp-factory-block--last" data-lazybg="<?=SITE_TEMPLATE_PATH?>/img/lp/blocks/fac-6.jpg?v=2"></div>
		</div>
	</div>
</section>
