...
<section class="s-lp-header">
	<div class="lp-header">
		...
		<div class="lp-header__right lp-header__right--osush">
			<img src="<?=SITE_TEMPLATE_PATH?>/img/lp/osush/header-item.png" alt="1" class="lp-header__img">
		</div>
	</div>
</section>


<section class="s-lp-princip s-def s-lp-princip--rightimg">
	<div class="container">
		<div class="row">
...
<section class="s-lp-sostav s-def">
	<div class="container">
		...
		<div class="sostav">
			<div class="sostav__img sostav__img--osush anim">
				<img data-lazy="<?=SITE_TEMPLATE_PATH?>/img/lp/osush/sostav-img.png" alt="1">
...
<section class="s-lp-preims" data-lazybg="<?=SITE_TEMPLATE_PATH?>/img/lp/osush/preims-bg.jpg?v=1">
	<div class="container">
		<div class="row">
			<div class="grid-6 grid-12_m">
	...
	<img src="" data-lazy="<?=SITE_TEMPLATE_PATH?>/img/lp/osush/preims-img.png" alt="" class="preims-img">
</section>
...
<!--
<section class="s-def s-osush-table">
	<div class="container">
		<div class="table-osush-wrap">
			<table class="table-osush">
				<thead>
					<tr>
						<th rowspan="3">Модель</th>
						<th rowspan="2">Рабочее давление</th>
						<th colspan="2">Расход воздуха на входе</th>
						<th rowspan="2">Диапазон рабочего давления</th>
						<th rowspan="2">Соединения на входе/выходе</th>
						<th rowspan="2">Размеры ДхШхВ</th>
						<th rowspan="2">Вес</th>
					</tr>

					<tr>
						<th colspan="2">Точка росы</th>
					</tr>
				...
				<tbody>
					<tr>
						<td rowspan="3" class="border-dark">
							<div class="lead">GA-5</div>
							<a href="#" class="link--blue fancy-modal" data-src="#modal-order" rel="nofollow">Подробнее</a>
						</td>
						<td class="dark">7</td>
						<td>300</td>
						<td class="dark">210</td>
						<td rowspan="3" class="border-dark">0-10</td>
						<td rowspan="3" class="dark border-dark">1/2</td>
						<td rowspan="3" class="border-dark">350x450x1000</td>
						<td rowspan="3" class="dark border-dark">50</td>
					</tr>
					<tr>
						<td class="dark">10</td>
						<td>411</td>
						<td class="dark">288</td>
					</tr>
					<tr>
						<td class="dark border-dark">13</td>
						<td class="border-dark">525</td>
						<td class="dark border-dark">368</td>
					</tr>

					<tr>
						<td rowspan="3" class="border-dark">
							<div class="lead">GA-8</div>
							<a href="#" class="link--blue fancy-modal" data-src="#modal-order" rel="nofollow">Подробнее</a>
						</td>
						<td class="dark">7</td>
						<td>500</td>
						...
						<td rowspan="3" class="border-dark">0-10</td>
						<td rowspan="3" class="dark border-dark">1/2</td>
						<td rowspan="3" class="border-dark">350x450x1200</td>
						<td rowspan="3" class="dark border-dark">56</td>
					</tr>
					<tr>
						<td class="dark">10</td>
						<td>685</td>
						<td class="dark">480</td>
					</tr>
					<tr>
						<td class="dark border-dark">13</td>
						<td class="border-dark">875</td>
						<td class="dark border-dark">613</td>
					</tr>

					<tr>
						<td rowspan="3" class="border-dark">
							<div class="lead">GA-12</div>
							<a href="#" class="link--blue fancy-modal" data-src="#modal-order" rel="nofollow">Подробнее</a>
						</td>
						<td class="dark">7</td>
						<td>700</td>
						<td class="dark">490</td>
						<td rowspan="3" class="border-dark">0-10</td>
						<td rowspan="3" class="dark border-dark">1/2</td>
						<td rowspan="3" class="border-dark">500x450x1000</td>
						<td rowspan="3" class="dark border-dark">98</td>
					</tr>
					<tr>
						<td class="dark">10</td>
						<td>959</td>
					...
					<tr>
						<td class="dark border-dark">13</td>
						<td class="border-dark">1225</td>
						<td class="dark border-dark">858</td>
					</tr>

					<tr>
						<td rowspan="3" class="border-dark">
							<div class="lead">GA-16</div>
							<a href="#" class="link--blue fancy-modal" data-src="#modal-order" rel="nofollow">Подробнее</a>
						</td>
						<td class="dark">7</td>
						<td>1000</td>
						<td class="dark">700</td>
						<td rowspan="3" class="border-dark">0-10</td>
						<td rowspan="3" class="dark border-dark">1/2</td>
						<td rowspan="3" class="border-dark">500x450x1200</td>
						<td rowspan="3" class="dark border-dark">106</td>
					</tr>
					<tr>
						<td class="dark">10</td>
						<td>1370</td>
						<td class="dark">959</td>
					</tr>
					<tr>
						<td class="dark border-dark">13</td>
						<td class="border-dark">1750</td>
						<td class="dark border-dark">1225</td>
					</tr>
