...
<section class="s-lp-header s-lp-header--nopad s-lp-header--cryogen">
	<div class="lp-header">
		...
		<div class="lp-header__right lp-header__right--cryogen">
			<img src="<?=SITE_TEMPLATE_PATH?>/img/lp/cryogen/header-item.png" alt="1" class="lp-header__img">
		</div>
	</div>
</section>
...
<section class="s-lp-cryo-sostav s-def-big">
	<div class="container">
		...
		<div class="cryo-sostav">
			...
			<div class="cryo-sostav__stage">
				<img data-lazy="<?=SITE_TEMPLATE_PATH?>/img/lp/cryogen/sostav.png" alt="" class="cryo-sostav__img">
				<div class="cryo-sostav__dots">
