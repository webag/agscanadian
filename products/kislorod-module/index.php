...
$APPLICATION->SetTitle("Modular Oxygen Stations");
?>
		...
		<div class="container">
			<div class="icon-left-blocks">
				...
				<div class="icon-left-block">
					...
					<div class="icon-left-block__content">
						<strong>Operation of stations from -50&nbsp;&deg;С up to&nbsp;+50&nbsp;&deg;С</strong>
	...
	<section class="s-module-complect s-def-big" data-lazybg="<?=SITE_TEMPLATE_PATH?>/img/lp/azot-module/complect-bg.jpg">
		<div class="container">
			<div class="section-title">
				<div class="h1">AGS Oxygen Station Set</div>
			</div>
		...
		<div class="container">
			...
			<div class="row-ng">
				<div class="lp-base">
					...
					<div class="h3">Adsorption oxygen generator with purity up to</div>
					<strong>95%</strong>
				</div>
				<div class="lp-base">
					<div class="lp-base__header">
					...
					<div class="h3">Cryogenic oxygen generator with purity up to</div>
					<strong>99.7%</strong>
				</div>
			</div>
		</div>
	...
	<section class="s-lp-module-preims s-def-big" data-lazybg="<?=SITE_TEMPLATE_PATH?>/img/lp/azot-module/preims-bg.jpg">
		<div class="container">
			<div class="section-title">
				<div class="h1">Advantages of modular oxygen units</div>
			</div>
...
global $arrFilter;
$arrFilter = Array(
	"PROPERTY_GENERATOR_TYPE_VALUE" => 'Modular Oxygen Stations'
);
?>
