...
$APPLICATION->SetTitle("Модульные кислородные станции");
?>
		...
		<div class="lp-header">
			<div class="lp-header__left">
				<div class="lp-header__content">
					<h1 class="lp-header__title">Модульные кислородные станции</h1>
					<div class="lp-header__descr">«АГС Инжиниринг» проектирует и производит блочно-модульные кислородные станции, работающие по&nbsp;технологии короткоцикловой адсорбции</div>
			...
			<div class="lp-header__right lp-header__right--am">
				<img src="<?=SITE_TEMPLATE_PATH?>/img/lp/azot-module/header-item.png" alt="1" class="lp-header__img">
			</div>
		</div>
	</section>


	<section class="s-lp-params">
		<div class="container">
	...
	<section class="s-module-complect s-def-big" data-lazybg="<?=SITE_TEMPLATE_PATH?>/img/lp/azot-module/complect-bg.jpg">
		<div class="container">
			<div class="section-title">
				<div class="h1">Комплектация кислородной станции AGS</div>
			</div>
		...
		<img data-lazy="<?=SITE_TEMPLATE_PATH?>/img/lp/azot-module/module-complect-img.png" alt="" class="module-complect-img">
			...
			<div class="row-ng">
				<div class="lp-base">
					<div class="lp-base__header">
						<img data-lazy="<?=SITE_TEMPLATE_PATH?>/img/lp/kislorod-module/base-1.jpg" alt="1">
					</div>
					<div class="h3">Адсорбционного генератора кислорода с&nbsp;чистотой до</div>
					<strong>95%</strong>
				</div>
				<div class="lp-base">
					<div class="lp-base__header">
						<img data-lazy="<?=SITE_TEMPLATE_PATH?>/img/lp/kislorod-module/base-2.jpg" alt="1">
					</div>
					<div class="h3">Криогенного кислородного генератора с&nbsp;чистотой до</div>
					<strong>99.7%</strong>
				</div>
			</div>
		</div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="grid-3 grid-12_s">
					<div class="icon-vert-block icon-vert-block--left">
	...
	<section class="s-lp-module-preims s-def-big" data-lazybg="<?=SITE_TEMPLATE_PATH?>/img/lp/azot-module/preims-bg.jpg">
		<div class="container">
			<div class="section-title">
				<div class="h1">Преимущества кислородных установок модульного типа</div>
			</div>
			...
			<div class="lp-box">
				...
				<div class="row">
					<div class="grid-9 grid-12_m">
						<img data-lazy="<?=SITE_TEMPLATE_PATH?>/img/lp/azot-module/box-big.jpg" alt="" class="img-responsive">
					</div>
