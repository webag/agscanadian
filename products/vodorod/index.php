...
<section class="s-lp-header s-lp-header--nopad">
	<div class="lp-header">
		...
		<div class="lp-header__right lp-header__right--vodorod">
			<img src="<?=SITE_TEMPLATE_PATH?>/img/lp/vodorod/header-item.png" alt="1" class="lp-header__img">
		</div>
	</div>
</section>


<section class="s-trigger-columns s-def-big">
	<div class="container">
		<div class="row">
...
<section class="s-lp-preims" data-lazybg="<?=SITE_TEMPLATE_PATH?>/img/lp/membrana/preims-bg.jpg">
	...
	<img src="" data-lazy="<?=SITE_TEMPLATE_PATH?>/img/lp/vodorod/preims-img.png" alt="" class="preims-img">
</section>
...
<section class="s-lp-variants s-def">
	<div class="container">
		...
		<div class="lp-variant selected">
			<div class="row">
				<div class="grid-6 grid-12_m">
					<img data-lazy="<?=SITE_TEMPLATE_PATH?>/img/lp/vodorod/variant-1.png" alt="" class="img-responsive">
				</div>
				<div class="grid-6 grid-12_m">
					<div class="user-content">
		...
		<div class="lp-variant">
			<div class="row">
				<div class="grid-6 grid-12_m">
					<img data-lazy="<?=SITE_TEMPLATE_PATH?>/img/lp/vodorod/variant-2.png" alt="" class="img-responsive">
				</div>
				<div class="grid-6 grid-12_m">
					<div class="user-content">
